...
inactive <- c(100426, 1006914, 1019679, 1012567, 10025103, 1000603, 1015601, 1005238, 10143,
              10682175, 1010739, 1016013, 1000754, 1005462, 1017508, 10453, 1028458, 1010889, 
              1003571, 1005077, 1018302, 100028, 457193, 1002592, 1009573, 100095, 1002206, 
              10071166, 1005643, 1002641, 100181, 1006276, 100081, 1001748, 1008238, 1010579,
              1000784, 1022056, 10082482)

inactive <- get.cid(inactive, quiet = TRUE, from.file = FALSE)
active <- c(1720, 3213, 4055, 6732, 8646, 11937, 94381, 151582, 273769, 659705, 712714, 976139, 1045636,
            1086433, 1101821, 1108556, 1347824, 1370828, 1596915, 2106461, 2114737, 2135723, 2309631,
            2369069, 2959022, 2998487, 3232884, 3232935, 3233193, 3233797, 3234280, 3234952, 3234984,
            3235122, 3246652, 5312137, 5351879, 5800609, 6603979)
active <- get.cid(active, quiet = TRUE, from.file = FALSE)

eda_inactive_data <- inactive[c("MolecularWeight", "XLogP", 
                                "HydrogenBondDonorCount", "HydrogenBondAcceptorCount")]
eda_inactive_data$Label <- "Inactive"
eda_active_data <- active[c("MolecularWeight", "XLogP", 
                            "HydrogenBondDonorCount", "HydrogenBondAcceptorCount")]
